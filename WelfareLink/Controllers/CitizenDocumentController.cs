...
namespace WelfareLink.Controllers
{
    public class CitizenDocumentController : Controller
    {
        ...
        public CitizenDocumentController(ICitizenService citizenService, ICitizenDocumentService documentService)
        {
        ...
        public async Task<IActionResult> UploadDocument(DocumentUploadViewModel model)
        {
            ...
            if (model.FileUpload.Length > 10 * 1024 * 1024) // 10 MB
            {
        ...
        public async Task<IActionResult> DocumentStatus(string status = "")
        {
            ...
            var viewModel = new DocumentStatusViewModel
            {
                Documents = documents,
                FilterStatus = status
            };
