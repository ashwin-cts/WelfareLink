...
export class CitizenService {
  ...
  resubmitApplication(applicationId: number, applicationData: WelfareApplication): Observable<ApiResponse> {
    return this.http.put<ApiResponse>(`${this.apiConfig.citizenApi}/CitizenApi/application/${applicationId}`, applicationData);
  }
}
