...
import { UpdateProfileRequest } from '../../models/compliance-officer';
...
export class EditProfileComponent implements OnInit {
  ...
  loadProfile() {
    this.isLoading = true;
    this.complianceService.getProfile(this.currentUserId!).subscribe({
      next: (data) => {
  ...
  onSubmit() {
    ...
    this.complianceService.updateProfile(this.currentUserId, payload).subscribe({
      next: (res) => {
        this.isSaving = false;
